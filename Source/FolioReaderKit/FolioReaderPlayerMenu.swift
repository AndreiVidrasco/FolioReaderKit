...
//        menuView.addSubview(line2)
        ...
        let style0 = UIButton(frame: CGRect(x: 0, y: line.frame.height+line.frame.origin.y, width: view.frame.width/3, height: 55))
        ...
        let style1 = UIButton(frame: CGRect(x: view.frame.width/3, y: line.frame.height+line.frame.origin.y, width: view.frame.width/3, height: 55))
        ...
        let style2 = UIButton(frame: CGRect(x: view.frame.width/1.5, y: line.frame.height+line.frame.origin.y, width: view.frame.width/3, height: 55))
